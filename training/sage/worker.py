...
def execute(a):
    ...
    require(Path(DiGiTSamplerCUDA.__file__).resolve()==HERE/'runtime/digit/DiGiTSamplerCUDA.so','Wrong sampler binary')
    ...
    install_runner(r)
    from training.sage import training_loop as loop
