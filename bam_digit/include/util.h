...
#ifdef DEBUG
    // #define DEBUG_PRINT(fmt, ...) printf("DEBUG: %s:%s:%d: " fmt, __FILE__, __FUNCTION__, __LINE__, ##__VA_ARGS__)
    #define DEBUG_PRINT(fmt, ...) printf("DEBUG: %s:%d: " fmt, __FUNCTION__, __LINE__, ##__VA_ARGS__)
#else
    #define DEBUG_PRINT(fmt, ...) // 什么都不做
#endif
